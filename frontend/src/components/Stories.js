...
const Stories = () => {
  return (
    <div className='border border-gray-300 border-solid rounded-lg p-4 flex gap-x-3 bg-white overflow-x-scroll'>
        ...
        <StoryItem photoUrl={photo7} title="foundr" />
        <StoryItem photoUrl={photo8} title="alobratmoi" />
        <StoryItem photoUrl={photo9} title="natasa.dizajn" />
        <StoryItem photoUrl={photo10} title="mili.codes" />
        <StoryItem photoUrl={photo11} title="rdigital021" />
        <StoryItem photoUrl={photo12} title="garyvee" />
        <StoryItem photoUrl={photo13} title="maxine.js" />
        <StoryItem photoUrl={photo14} title="sajon.co" />
        <StoryItem photoUrl={photo15} title="sadznam" />
    </div>
  )
}
